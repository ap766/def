...
import android.annotation.SuppressLint;//Unique
...
MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            @SuppressLint("SetTextI18n")//UNique
            @Override
        ...
        bminus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                v1 = Float.parseFloat(ET_Result.getText()+""); //yes
                sub = true;
                ET_Result.setText(null); //yes
        ...
        beql.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                v2 = Float.parseFloat(String.valueOf(ET_Result.getText()));//yes
                //only unique place with no "" in get or set here|
